...
{
    public partial class hospitalisationControle : UserControl
    {
        string resultF;
        public hospitalisationControle()
        {
            InitializeComponent();
        }

        private void gravite_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void enregistrer_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand command = new SqlCommand("insert into Hospitalisation values ('" + gravite.Text + "','" + traitement.Text + "','" + duree.Text + "','" + resultF + "')", con);
        ...
        private void guerison_CheckedChanged(object sender, EventArgs e)
        {
            resultF = "Guérison";
        }

        private void deces_CheckedChanged(object sender, EventArgs e)
        {
            resultF = "Décés";
        }
